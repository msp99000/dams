                ...
                <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                        ...
                        foreach ($users as $user) {
                            ...
                            echo "<td>" . $user['dob'] . "</td>";
                            echo "<td><a href='?action=edit&Id=".$user['student_id']."'><i class='fas fa-fw fa-edit'></i>Edit</a></td>";
                            echo "<td><a href='?action=delete&Id=".$user['student_id']."'><i class='fas fa-fw fa-trash'></i>Delete</a></td>";
                            echo "</tr>";
                        }
